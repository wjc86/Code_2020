...
public class Turret extends SubsystemBase {
    ...
    public void setTurretPosition(double wantedDegrees) {
        ...
        System.out.println("PID Out: " + pid.calculate(degrees, wantedDegrees));
        System.out.println(".set Out: " + pid.calculate(degrees, wantedDegrees) * Constants.TURRET_PERCENT_OUTPUT * Constants.MOTOR_TO_TURRET_GEAR_RATIO);
        rotateMotor.set(ControlMode.Position, pid.calculate(degrees, wantedDegrees) * Constants.TURRET_PERCENT_OUTPUT * Constants.MOTOR_TO_TURRET_GEAR_RATIO);
    }
