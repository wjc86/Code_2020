...
public class VL53L0XSensors {
    ...
    // Respective DIO
    private List<DigitalOutput> doArray = Arrays.asList(new DigitalOutput(1)/*, new DigitalOutput(1)*/);
	...
	public boolean init() {
        ...
        System.out.println(vl53l0xArray);
        SmartDashboard.putBoolean("Printed Array", true);

        initialized = result;
        SmartDashboard.putBoolean("Init", initialized);
