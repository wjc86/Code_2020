...
public class VL53L0X_v1{
	...
	private static boolean verbose = true;//"true".equals(System.getProperty("vl53l0x.debug", "false"));

	protected I2C m_i2c;
	//private I2CDevice vl53l0x;
	

	public VL53L0X_v1(I2C.Port port) {
		this(port,VL53L0X_I2CADDR);
	}

	public VL53L0X_v1(I2C.Port port,int address)  {
	...
	public void startRanging(int mode) throws Exception {
		this.m_i2c.write(0x88,(byte)0x00); //Set Standard I2C Mode
		if (mode >= VL53L0X_GOOD_ACCURACY_MODE && mode <= VL53L0X_HIGH_SPEED_MODE) {
			this.m_i2c.write(VL53L0X_REG_SYSRANGE_START, (byte)0x02); //Back to back ranging
	...
	public VL53L0XData getVL53L0XData() throws Exception {
		...
		if (verbose) {
			...
			SmartDashboard.putString("StringBuffer", sb.toString().trim());
		}
