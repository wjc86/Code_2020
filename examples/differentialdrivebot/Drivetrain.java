...
public class Drivetrain {
  public static final double kMaxSpeed = 10; // meters per second
  public static final double kMaxAngularSpeed = 2 * Math.PI; // one rotation per second

  private static final double kTrackWidth = 2; // meters
  private static final double kWheelRadius = 0.5; // meters
  ...
  private final WPI_TalonFX m_rightMaster = new WPI_TalonFX(2); 

  private final AHRS m_gyro = new AHRS(SPI.Port.kMXP);

  // private final PIDController m_leftPIDController = new PIDController(1, 0, 0);
  // private final PIDController m_rightPIDController = new PIDController(1, 0, 0);
  SimpleMotorFeedforward feedforward = new SimpleMotorFeedforward(0.156, 0.747, 0.068);
