...
public class RobotContainer {
  ...
  private JoystickButton shootButton = new JoystickButton(Joy, 1);
  ...
  public RobotContainer() {
    ...
    m_ConveyorSubsystem.setDefaultCommand(new ConveyorIntake());
  }
  ...
  private void configureButtonBindings() {
    shootButton.whenHeld(new ConveyorShoot());
  }
